# Form implementation generated from reading ui file 'gost.ui'
#
...
class Ui_GOST(object):
    def setupUi(self, GOST):
        ...
        self.tab_widget = QtWidgets.QTabWidget(GOST)
        ...
        self.group_box_options = QtWidgets.QGroupBox(GOST)
        ...
        self.combo_box_gost_mode = QtWidgets.QComboBox(self.group_box_options)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.combo_box_gost_mode.sizePolicy().hasHeightForWidth())
        self.combo_box_gost_mode.setSizePolicy(sizePolicy)
        self.combo_box_gost_mode.setObjectName("combo_box_gost_mode")
        self.combo_box_gost_mode.addItem("")
        self.combo_box_gost_mode.addItem("")
        self.combo_box_gost_mode.addItem("")
        self.combo_box_gost_mode.addItem("")
        self.form_layout_options.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.combo_box_gost_mode)
        ...
        self.combo_box_mode = QtWidgets.QComboBox(GOST)
        ...
        self.button_make = QtWidgets.QPushButton(GOST)
        ...
        self.button_options = QtWidgets.QPushButton(GOST)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, GOST):
        ...
        GOST.setWindowTitle(_translate("GOST", "Form"))
        self.group_box_input.setTitle(_translate("GOST", "Input text"))
        self.group_box_output.setTitle(_translate("GOST", "Output text"))
        self.tab_widget.setTabText(self.tab_widget.indexOf(self.tab_text), _translate("GOST", "Text"))
        self.tab_widget.setTabText(self.tab_widget.indexOf(self.tab_document), _translate("GOST", "Document"))
        self.group_box_options.setTitle(_translate("GOST", "Options"))
        self.label_des_mode.setText(_translate("GOST", "Mode"))
        self.combo_box_gost_mode.setItemText(0, _translate("GOST", "ECB"))
        self.combo_box_gost_mode.setItemText(1, _translate("GOST", "CBC"))
        self.combo_box_gost_mode.setItemText(2, _translate("GOST", "CFB"))
        self.combo_box_gost_mode.setItemText(3, _translate("GOST", "OFB"))
        self.label_key.setText(_translate("GOST", "Key (hex - 256 bit)"))
        self.label_iv.setText(_translate("GOST", "IV (hex - 64 bit)"))
        self.combo_box_mode.setItemText(0, _translate("GOST", "Encrypt"))
        self.combo_box_mode.setItemText(1, _translate("GOST", "Decrypt"))
        self.button_make.setText(_translate("GOST", "Make"))
