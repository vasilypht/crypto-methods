...
class Ui_Scytale(object):
    def setupUi(self, Scytale):
        ...
        self.combo_box_enc_proc = QtWidgets.QComboBox(Scytale)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.combo_box_enc_proc.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.combo_box_enc_proc.setFrame(True)
