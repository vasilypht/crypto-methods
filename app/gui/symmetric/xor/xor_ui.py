...
class Ui_XOR(object):
    def setupUi(self, XOR):
        ...
        self.frame_1.setMaximumSize(QtCore.QSize(16777215, 110))
        ...
        self.group_box_options.setMaximumSize(QtCore.QSize(800, 16777215))
        ...
        self.verticalLayout_5.addWidget(self.group_box_options)
