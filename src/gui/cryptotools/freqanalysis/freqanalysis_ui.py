...
class Ui_freqanalysis(object):
    def setupUi(self, freqanalysis):
        ...
        self.verticalLayout_5.addWidget(self.tab_widget, 0, QtCore.Qt.AlignmentFlag.AlignTop)
        ...
        self.form_layout_params = QtWidgets.QFormLayout()
        self.form_layout_params.setObjectName("form_layout_params")
        self.label_lang = QtWidgets.QLabel(freqanalysis)
        self.label_lang.setObjectName("label_lang")
        self.form_layout_params.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_lang)
        self.combo_box_lang = QtWidgets.QComboBox(freqanalysis)
        self.combo_box_lang.setObjectName("combo_box_lang")
        self.combo_box_lang.addItem("")
        self.combo_box_lang.addItem("")
        self.form_layout_params.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.combo_box_lang)
        self.combo_box_text_style = QtWidgets.QComboBox(freqanalysis)
        self.combo_box_text_style.setObjectName("combo_box_text_style")
        self.combo_box_text_style.addItem("")
        self.combo_box_text_style.addItem("")
        self.combo_box_text_style.addItem("")
        self.form_layout_params.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.combo_box_text_style)
        self.label_text_style = QtWidgets.QLabel(freqanalysis)
        self.label_text_style.setObjectName("label_text_style")
        self.form_layout_params.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_text_style)
        self.horizontal_layout_1.addLayout(self.form_layout_params)
        ...
        self.button_analysis = QtWidgets.QPushButton(freqanalysis)
        ...
        self.vertical_layout_1.addWidget(self.button_analysis)
        self.button_dechipher = QtWidgets.QPushButton(freqanalysis)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.vertical_layout_1.addWidget(self.button_dechipher)
        ...
        self.group_box_freq_table = QtWidgets.QGroupBox(freqanalysis)
        self.group_box_freq_table.setObjectName("group_box_freq_table")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.group_box_freq_table)
        self.verticalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.freq_table_widget = QtWidgets.QTableWidget(self.group_box_freq_table)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.freq_table_widget.sizePolicy().hasHeightForWidth())
        self.freq_table_widget.setSizePolicy(sizePolicy)
        self.freq_table_widget.setMaximumSize(QtCore.QSize(150, 16777215))
        self.freq_table_widget.setObjectName("freq_table_widget")
        self.freq_table_widget.setColumnCount(0)
        self.freq_table_widget.setRowCount(0)
        self.verticalLayout_3.addWidget(self.freq_table_widget)
        self.horizontal_layout_2.addWidget(self.group_box_freq_table)
    ...
    def retranslateUi(self, freqanalysis):
        ...
        self.group_box_freq_table.setTitle(_translate("freqanalysis", "Frequency table"))
