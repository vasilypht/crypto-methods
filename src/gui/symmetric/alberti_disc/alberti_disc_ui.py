...
class Ui_alberti_disc(object):
    def setupUi(self, alberti_disc):
        ...
        self.spin_box_key_alphabet_shift.setButtonSymbols(QtWidgets.QAbstractSpinBox.ButtonSymbols.NoButtons)
        ...
        self.spin_box_iteration_step.setButtonSymbols(QtWidgets.QAbstractSpinBox.ButtonSymbols.NoButtons)
