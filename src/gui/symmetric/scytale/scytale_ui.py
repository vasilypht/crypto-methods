...
class Ui_scytale(object):
    def setupUi(self, scytale):
        ...
        self.spin_box_rows.setButtonSymbols(QtWidgets.QAbstractSpinBox.ButtonSymbols.NoButtons)
        ...
        self.spin_box_columns.setButtonSymbols(QtWidgets.QAbstractSpinBox.ButtonSymbols.NoButtons)
